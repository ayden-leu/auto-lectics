...
func _determineIfGuessMatchesSelectedEntry(guess:String) -> void:
	...
	if guess.to_lower() == correctName.to_lower():
		...
		_sfxEventHandler.play("entryGuessedCorrectly")
		...
		_sfxEventHandler.play("entryNameSubmitted")
